...
#
# * performs  kmeans clustering from the scipy library (https://www.scipy.org/) on a user-defined vector layer with a user-defined number of classes
...
# better integrated in automatic workflows. This mainly applies when starting centroids are distributed randomly. To increase replicability of 
